...
@section('title', 'Tambah Genre - Sikutu')
@section('header', 'Tambah Genre Baru')
    ...
    <form action="{{ route('admin.genre.store') }}" method="POST">
        ...
        <div class="space-y-5">
            <div>
                ...
                <input type="text" id="nama_genre" name="nama_genre" value="{{ old('nama_genre') }}" required class="input-field" placeholder="Contoh: Fiksi, Sejarah, Sains">
            ...
            <div>
                ...
                <textarea id="deskripsi" name="deskripsi" rows="4" class="input-field" placeholder="Masukkan deskripsi genre ini (opsional)">{{ old('deskripsi') }}</textarea>
        ...
        <div class="mt-8 flex justify-end border-t pt-4">
            ...
            <button type="submit" class="btn-primary">Simpan Genre</button>
        </div>
    </form>
</div>
@endsection
