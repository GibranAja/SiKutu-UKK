...
@section('title', 'Edit Anggota - Sikutu')
...
<div class="card max-w-4xl animate-[fadeIn_0.3s_ease-in-out]">
    <form action="{{ route('admin.anggota.update', $anggota->uuid) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <input type="text" id="nis" name="nis" value="{{ old('nis', $anggota->nis) }}" required class="input-field" placeholder="Contoh: 123456789">
                ...
                <div>
                    ...
                    <input type="text" id="nama_lengkap" name="nama_lengkap" value="{{ old('nama_lengkap', $anggota->nama_lengkap) }}" required class="input-field" placeholder="Masukkan nama lengkap siswa">
                ...
                <div>
                    ...
                    <input type="text" id="username" name="username" value="{{ old('username', $anggota->username) }}" required class="input-field" placeholder="Gunakan huruf, angka, atau dash">
                    @error('username') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                </div>

                <div>
                    <label for="email" class="block text-sm font-medium text-gray-700 mb-1 font-oswald">Email</label>
                    <input type="email" id="email" name="email" value="{{ old('email', $anggota->email) }}" class="input-field" placeholder="opsional@email.com">
            ...
            <div class="space-y-5">
                <div class="flex gap-4">
                    <div class="flex-1">
                        ...
                        <x-custom-select name="kelas" :options="['' => 'Pilih Kelas', '10' => '10', '11' => '11', '12' => '12']" selected="{{ old('kelas', $anggota->kelas) }}" placeholder="Pilih Kelas" />
                    ...
                    <div class="flex-[2]">
                        ...
                        @endphp
                        <x-custom-select name="jurusan" :options="$optionsJurusan" selected="{{ old('jurusan', $anggota->jurusan) }}" placeholder="Pilih Jurusan" />
                ...
                <div>
                    ...
                    <input type="text" id="no_telepon" name="no_telepon" value="{{ old('no_telepon', $anggota->no_telepon) }}" class="input-field" placeholder="Contoh: 081234567890">
                ...
                <div>
                    ...
                    <textarea id="alamat" name="alamat" rows="2" class="input-field" placeholder="Masukkan alamat lengkap">{{ old('alamat', $anggota->alamat) }}</textarea>
                ...
                <div class="flex gap-4">
                    <div class="flex-1">
                        ...
                        <x-custom-select name="status_anggota" :options="['AKTIF' => 'Aktif', 'NONAKTIF' => 'Nonaktif', 'DIBLOKIR' => 'Diblokir']" selected="{{ old('status_anggota', $anggota->status_anggota) }}" placeholder="Pilih Status" />
                    ...
                    <div class="flex-1">
                        ...
                        <input type="date" id="masa_berlaku" name="masa_berlaku" value="{{ old('masa_berlaku', $anggota->masa_berlaku) }}" required class="input-field">
...
<div class="mt-8 card max-w-4xl animate-[fadeIn_0.5s_ease-in-out]">
    <h3 class="font-oswald text-lg font-medium text-gray-800 mb-4 border-b pb-2">Reset Password Anggota</h3>
    <form action="{{ route('admin.anggota.reset-password', $anggota->uuid) }}" method="POST">
        @csrf
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="password" id="new_password_confirmation" name="new_password_confirmation" required class="input-field" placeholder="Ketik ulang password">
            </div>
        </div>
